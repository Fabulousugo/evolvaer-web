  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="absolute left-[18%] top-[24%] h-[32rem] w-[32rem] rounded-full bg-[#2563EB]/[0.12] blur-[170px]" />

        <div className="absolute right-[10%] top-[15%] h-[30rem] w-[30rem] rounded-full bg-[#22D3EE]/[0.08] blur-[160px]" />

        <div className="absolute bottom-[-12rem] left-1/2 h-[34rem] w-[34rem] -translate-x-1/2 rounded-full bg-[#A855F7]/[0.08] blur-[170px]" />
      ...
      <div className="evolvaer-container relative z-10">
        <div className="grid gap-14 lg:grid-cols-[0.95fr_1.05fr] lg:items-end">
          ...
          <div className="lg:justify-self-end">
            <div className="w-full max-w-[480px] rounded-[1.8rem] border border-white/[0.09] bg-white/[0.035] p-6 backdrop-blur-xl sm:p-8">
              ...
              <div className="mt-7 space-y-3">
                <Link
                  href="/ventures"
                  className="group flex items-center justify-between rounded-[1.15rem] border border-[#3B82F6]/20 bg-[#3B82F6]/[0.08] px-5 py-5 transition-all duration-300 hover:border-[#3B82F6]/40 hover:bg-[#3B82F6]/[0.13]"
                >
                  <div>
                    ...
                    <p className="mt-1 text-xs leading-5 text-white/35">
                      See the products and ventures emerging from the
                      system.
                    </p>
                  </div>

                  <span className="ml-5 flex h-9 w-9 shrink-0 items-center justify-center rounded-full border border-[#3B82F6]/25 text-[#60A5FA] transition-all duration-300 group-hover:bg-[#3B82F6] group-hover:text-white">
                ...
                <Link
                  href="/research"
                  className="group flex items-center justify-between rounded-[1.15rem] border border-white/[0.07] bg-white/[0.025] px-5 py-5 transition-all duration-300 hover:border-[#22D3EE]/25 hover:bg-[#22D3EE]/[0.05]"
                >
                  <div>
                    <p className="text-sm font-semibold text-white">
                  ...
                  <span className="ml-5 flex h-9 w-9 shrink-0 items-center justify-center rounded-full border border-white/[0.08] text-white/45 transition-all duration-300 group-hover:border-[#22D3EE]/30 group-hover:text-[#67E8F9]">
                    <ArrowUpRight className="h-4 w-4" />
                  </span>
                </Link>
              </div>
        ...
        <div className="mt-20 border-t border-white/[0.08] pt-7 lg:mt-28">
          <div className="flex flex-col gap-6 sm:flex-row sm:items-center sm:justify-between">
            ...
            <Link
              href="/about"
              className="group inline-flex items-center gap-3 text-sm font-semibold text-white/48 transition-colors hover:text-white"
            >
